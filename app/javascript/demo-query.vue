                ...
                <b-card-header v-b-modal.modalBox class="border-1 py-2">
                    ...
                    <div class="switchBtn mt-4 mb-4">
                        ...
                        <dropdown-select
                            ...
                            class="tool-bar-el px-0 mb-1 col-md-3"/><!--v-if="data.outputs.length > 1"-->
                        <p style="color:gray;font-size:1.4em;position:relative;right:30px;ml-4" v-if="job_status == 'finished' && taskOutputs.length>1" ><i>You could select different task outputs to check their visualizations.</i></p>
                    </div>
